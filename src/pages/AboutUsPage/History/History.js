...
const History = () => {
  // must return JSX
  return (
      <p data-testid='history' className='history'>
        ...
        units, and is one of the most organized processing and finishing garment clusters in India.
        The firm came into existence in the year 2005 as a Sole Proprietorship concern in Bangalore,
        Tamil Nadu. In the year 2007 it started as family enterprise with a tiny shop selling Men
        apparel at much lesser price than market and expanded to full men wear during next six
        months. The journey continued and in 2011 launched its first exclusively brand store in
        Bangalore with bigger retailing space for Men wear, Women wear and Kids clothing. Spark
        Clothings is engaged into multiple business activities which include manufacturing,
        supplying and trading in a wide array of clothing products which include Women Wear, Polo
